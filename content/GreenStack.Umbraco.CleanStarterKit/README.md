# GreenStack.Umbraco.CleanStarterKit

A GitHub template repository for Umbraco 17 with the Clean Starter Kit, preconfigured for [GreenStack](https://umbhost.net) hosting.
